...
class SelectorLogger
{
    ...
    public function __construct($emitter, $fileName, $level = 'DEBUG')
    {
        ...
        if (!empty($fileName)) {
            $this->filePath = APP_ROOT . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR . 'selector' . DIRECTORY_SEPARATOR . $fileName;
        }
        if (empty($this->filePath)) {
            $this->filePath = APP_ROOT . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR . 'selector' . DIRECTORY_SEPARATOR . 'log.log';
        }

...
class RatingDebugController extends AbstractController
{
    ...
    /**
     * @Route("/debug/rating/horse/{horseId}/race/{raceId}/historic_record/{histId}", name="debug_rating")
     *
     * @param int $horseId
     * @param int $raceId
     * @param int $histId
     * @return JsonResponse
     */
    public function index(int $horseId, int $raceId, int $histId): JsonResponse
    {
        ...
        $handicapRawData = "generateHandicap();HORSE=".$historicResult->getHorseId().";RACE=".$historicResult->getRaceId().";RACE_DISTANCE=".$historicResult->getRaceDistance().";HORSE_POSITION=".$historicResult->getHorsePosition().";HANDICAP_RESULT=".$historicResult->getHandicap();
        ...
        // distance new can be ommited in some cases!
        $distanceRawData = "distanceNewRank();HORSE=".$historicResult->getHorseId().";RACE=".$historicResult->getRaceId().";RACE_DISTANCE=".$historicResult->getRaceDistance();
        $distanceNewRankRawData = $this->debugService->debugLogParse($distanceRawData, $contents);
        ...
        return new JsonResponse([
            ...
            'rawData' => (object)[
                ...
                'distanceNewRank' => (object)$distanceNewRankRawData[0],
            ],

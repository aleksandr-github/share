...
class ClearLogsAndDBCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($input->getArgument('force') == "YES") {
            ...
            $answer = $io->choice("You're about to COMPLETELY destroy data in DB and in logs. Are you ABSOLUTELY sure you know what you're doing?", ["YES", "NO"]);
        }
        ...
        if ($answer == "YES") {
            ...
            $mysqli->query($sql);
            $io->caution("DB has been emptied.");
            ...
            $io->caution("Log files has been emptied.");

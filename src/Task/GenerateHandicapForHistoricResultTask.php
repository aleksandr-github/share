...
class GenerateHandicapForHistoricResultTask extends AbstractMySQLTask implements Task
{
    ...
    public function __construct(AlgorithmStrategyInterface $algorithm, HistoricResult $histResult, float $timerHandicapMultiplier, float $handicapModifier, $raceDistance)
    {
        parent::__construct();
        ...
        $this->timer = $timerHandicapMultiplier;
        $this->modifier = $handicapModifier;
    }
    ...
    public function run(Environment $environment)
    {
        ...
        $distance = round($this->raceDistance / 100);
        ...
        $this->debugLogger->varLog([
            ...
            'RACE_DISTANCE_DETAILS_LENGTH' => $this->raceDistance,
